...
//    }
            ...
            custom.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    new Thread(() -> {
                        ...
                        System.out.println("Saved world to DB");
                    }).start();
                }
            });
        }
            ...
            custom.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    new Thread(() -> {
                        ...
                        canvas.repaint();
                        System.out.println("Loaded world from DB");
                    }).start();
                }
            });
        }
    ...
    private void setButton(Holder panel, WorldCanvas canvas){
        ...
        JButton saveWorld = getButton("Save World", canvas, 7, 1430, 728, 100, 50, Color.WHITE, new Color(51, 51, 51, 255));
        panel.add(saveWorld);
        JButton loadWorld = getButton("Load World", canvas, 8, 1320, 728, 100, 50, Color.WHITE, new Color(51, 51, 51, 255));
        panel.add(loadWorld);
